...
public class ConsumerController {
	...
	public void updateConsumer(@RequestBody Consumer consumer, @PathVariable Integer id) {
	...
	*/
	@RequestMapping(value = "/setcardbalance/{cardNumber}/{value}", method = RequestMethod.PUT)
	public void setBalance(@RequestBody @PathVariable int cardNumber, @PathVariable double value) {
