...
public class Consumer {
	...
	/**
	 * @param residencePhoneNumber the residencePhoneNumber to set
	 */
	...
	/**
	 * @param drugstoreNumber the drugstoreNumber to set
	 */
	...
	public String toString() {
		return "Consumer [id=" + id + ", name=" + name + ", documentNumber=" + documentNumber + ", birthDate="
				+ birthDate + ", mobilePhoneNumber=" + mobilePhoneNumber + ", residencePhoneNumber="
				+ residencePhoneNumber + ", phoneNumber=" + phoneNumber + ", email=" + email + ", street=" + street
				+ ", number=" + number + ", city=" + city + ", country=" + country + ", portalCode=" + portalCode
				+ ", foodCardNumber=" + foodCardNumber + ", foodCardBalance=" + foodCardBalance + ", fuelCardNumber="
				+ fuelCardNumber + ", fuelCardBalance=" + fuelCardBalance + ", drugstoreNumber=" + drugstoreNumber
				+ ", drugstoreCardBalance=" + drugstoreCardBalance + "]";
	}
