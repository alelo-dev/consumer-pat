...
public class ExtractFoodServiceTest {
    ...
    private ExtractFoodService extractService;

    @BeforeEach
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        extractService = new ExtractFoodService(cardRepository, extractRepository);
    }
    ...
    public void testBuyWithSufficientBalance() throws BusinessSaldoException {
        ...
        dto.setProductDescription("Teste produto");

        // Executar a compra
        extractService.buy(dto);

        // Verificar se o saldo do cartão foi atualizado corretamente
        assertEquals(cardBalance - purchaseValue, mockCard.getCardBalance());
