...
public class FoodCardTest {
    ...
    @Test
    public void shouldApply10PercentDiscountWhenCalculateFoodCardDebitValue() {

        BigDecimal value = new BigDecimal("100.50");
        BigDecimal debitValue = card.calculateDebitValue(value);

        assertThat(debitValue, comparesEqualTo(new BigDecimal("90.45")));
    ...
    public void shouldDebit() {
        ...
        consumerMock.setFoodCardBalance(new BigDecimal("100"));
        ...
        assertThat(consumer.getFoodCardBalance(), comparesEqualTo(new BigDecimal("90")));
        ...
        assertThat(consumer.getFoodCardBalance(), comparesEqualTo(new BigDecimal("70")));
    ...
    public void shouldCredit() {
        ...
        assertThat(consumer.getFoodCardBalance(), comparesEqualTo(new BigDecimal("100")));

        value = new BigDecimal("20");
        consumer = card.credit(consumer, value);
        assertThat(consumer.getFoodCardBalance(), comparesEqualTo(new BigDecimal("120")));
