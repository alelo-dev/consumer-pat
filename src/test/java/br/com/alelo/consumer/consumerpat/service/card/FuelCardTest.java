...
public class FuelCardTest {
    ...
    @Test
    public void shouldApply35PercentIncreaseWhenCalculateFuelCardDebitValue() {

        BigDecimal value = new BigDecimal("100.50");

        BigDecimal debitValue = card.calculateDebitValue(value);

        assertThat(debitValue, comparesEqualTo(new BigDecimal("135.67")));
    ...
    public void shouldDebit() {
        ...
        consumerMock.setFuelCardBalance(new BigDecimal("100"));
        ...
        assertThat(consumer.getFuelCardBalance(), comparesEqualTo(new BigDecimal("90")));

        Mockito.when(consumerRepository.findByFoodCardNumber(cardNumber)).thenReturn(Optional.of(consumer));

        value = new BigDecimal("20");
        consumer = card.debit(cardNumber, value);
        assertThat(consumer.getFuelCardBalance(), comparesEqualTo(new BigDecimal("70")));
    ...
    public void shouldCredit() {
        ...
        assertThat(consumer.getFuelCardBalance(), comparesEqualTo(new BigDecimal("100")));

        value = new BigDecimal("20");
        consumer = card.credit(consumer, value);
        assertThat(consumer.getFuelCardBalance(), comparesEqualTo(new BigDecimal("120")));
    ...
    public void shouldThrowExceptionWhenDebitAndConsumerNotFound() {
        ...
        Mockito.when(consumerRepository.findByFuelCardNumber(cardNumber)).thenReturn(Optional.ofNullable(null));
